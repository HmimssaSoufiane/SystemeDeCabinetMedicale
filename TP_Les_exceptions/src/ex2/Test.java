...
public class Test {
	public static void main(String[] args) {
		...
		try {
			EntNat number1;
			EntNat number2;
			number1 = new EntNat(1548);
			number2 = new EntNat(12548);
			EntNat res;
			System.out.println("Nombre 1= " + number1.getN());
			System.out.println("Nombre 2= " + number2.getN());
			res = EntNat.somme(number1, number2);
			System.out.println("La somme = " + res.getN());
			res = EntNat.diff(number1, number2);
			System.out.println("La diff = " + res.getN());
			res = EntNat.produit(number1, number2);
